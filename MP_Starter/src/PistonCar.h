...
#ifndef MP_PISTONCAR_H
#define MP_PISTONCAR_H
...
class PistonCar {
public:
    PistonCar(float x, float y, float z, float camRadius, float topBound, float botBound, float leftBound,
             float rightBound);
